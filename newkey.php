...
//if (!isset($_SESSION['email']) OR $_SESSION['root'] != 'n') {
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                ...
                <p>Nessa págica você terá que mudar sua senha.</p>
                <hr>
                <p class="mb-0">Aqui é o seu primeiro acesso. Por segurança é necessário mudar a senha!</p>
            </div>
